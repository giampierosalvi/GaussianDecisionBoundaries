...
p1W = ttk.Entry(gaussian1ParameterFrame, textvariable=p1, width=entryWidth, font=defaultFont)
mu1xW = ttk.Entry(gaussian1ParameterFrame, textvariable=mu1x, width=entryWidth, font=defaultFont)
mu1yW = ttk.Entry(gaussian1ParameterFrame, textvariable=mu1y, width=entryWidth, font=defaultFont)
s1xW = ttk.Entry(gaussian1ParameterFrame, textvariable=s1x, width=entryWidth, font=defaultFont)
s1yW = ttk.Entry(gaussian1ParameterFrame, textvariable=s1y, width=entryWidth, font=defaultFont)
s1xyW = ttk.Entry(gaussian1ParameterFrame, textvariable=s1xy, width=entryWidth, font=defaultFont)
s1yxW = ttk.Entry(gaussian1ParameterFrame, textvariable=s1xy, width=entryWidth, font=defaultFont)
gaussian2ParameterFrame = ttk.LabelFrame(gaussianParameterFrame, text='Gaussian 2')
p2W = ttk.Label(gaussian2ParameterFrame, text='1-p1')
mu2xW = ttk.Entry(gaussian2ParameterFrame, textvariable=mu2x, width=entryWidth, font=defaultFont)
mu2yW = ttk.Entry(gaussian2ParameterFrame, textvariable=mu2y, width=entryWidth, font=defaultFont)
s2xW = ttk.Entry(gaussian2ParameterFrame, textvariable=s2x, width=entryWidth, font=defaultFont)
s2yW = ttk.Entry(gaussian2ParameterFrame, textvariable=s2y, width=entryWidth, font=defaultFont)
s2xyW = ttk.Entry(gaussian2ParameterFrame, textvariable=s2xy, width=entryWidth, font=defaultFont)
s2yxW = ttk.Entry(gaussian2ParameterFrame, textvariable=s2xy, width=entryWidth, font=defaultFont)
drawingControlFrame = ttk.LabelFrame(controlFrame, text='Drawing')
drawTypeW = ttk.Combobox(drawingControlFrame, textvariable=drawType, font=defaultFont)
drawTypeW['values'] = ('Decision Boundary', 'PDF difference', 'Posterior difference')
drawPDFContourW = ttk.Checkbutton(drawingControlFrame, text="Draw PDF Contours", variable=drawPDFContour)
...
redrawButton = ttk.Button(drawingControlFrame, text="Redraw", command=lambda: redraw(fig))
