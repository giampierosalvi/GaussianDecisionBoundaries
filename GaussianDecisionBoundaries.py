...
class GaussianDecisionBoundaries(ttk.Frame):
   ...
   def initUI(self):
      ...
      e['p2W'] = ttk.Label(gaussian2ParameterFrame, text='1-P(t=c1)')
      ...
      p1L = ttk.Label(gaussian1ParameterFrame, text='P(t=c1)')
      ...
      p2L = ttk.Label(gaussian2ParameterFrame, text='P(t=c2)')
